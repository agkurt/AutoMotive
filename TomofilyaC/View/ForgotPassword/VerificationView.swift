...
//  TomofilyaC
//
//  Created by Ahmet Göktürk Kurt on 20.08.2023.
//

import UIKit

class VerificationView : UIView, UITextFieldDelegate {
    ...
    func setupUI() {
        ...
        configureLabel(mailVerificationLabel, text: "Parolamı Unuttum", hex: UIColor.white, name: "Poppins-Light", size: 12, aligment: .center)
        configureLabel(informationLabel, text: "Sana parola yenileme linki göndermemiz için mail adresini girmelisin.", hex: UIColor.white, name: "Poppins-Light", size: 10, aligment: .center)
        configureLabel(titleLabel, text: "Mailini Gir", hex: UIColor.white, name: "Poppins-Light", size: 12, aligment: .center)
